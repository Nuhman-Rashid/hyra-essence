        ...
        <div className="md:w-1/2 p-6 md:p-8 flex flex-col justify-between overflow-y-auto max-h-[70vh] md:max-h-[80vh]">
          ...
          <div className="flex flex-col space-y-3.5 pt-6 mt-6 border-t border-[#EFE8DD]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full flex items-center justify-center gap-2.5 py-4 bg-[#111111] hover:bg-[#C8A96B] text-[#FAF8F5] text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 rounded-xl shadow-md"
            >
