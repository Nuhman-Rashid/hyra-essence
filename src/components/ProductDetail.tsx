        ...
        <div className="lg:col-span-5 flex flex-col space-y-6 md:space-y-8 text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-[#EFE8DD]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#C8A96B] hover:bg-[#B89B72] text-white text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 rounded-xl shadow-md group"
            >
              <svg
      ...
      <div className="block sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#FFFEF2]/95 backdrop-blur-md border-t border-[#EFE8DD] p-3 shadow-[0_-8px_30px_rgba(0,0,0,0.06)]">
        <div className="flex items-center gap-2 max-w-md mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex-grow flex items-center justify-center gap-2 h-12 bg-[#C8A96B] hover:bg-[#B89B72] text-white text-xs font-bold uppercase tracking-[0.15em] transition-all duration-300 rounded-xl text-center group shadow-md"
          >
            <svg
              className="w-4 h-4 text-white transition-colors duration-300 shrink-0"
              viewBox="0 0 448 512"
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
            >
